...
- ✅ **v1.2 Cart and Checkout Foundation** — shipped 2026-03-07 (Phases 11-14)
...
Plans:
- [x] 13-01: Aplicar guardas de estado ativo em todos os fluxos de mutação de carrinho
- [x] 13-02: Adicionar testes de autorização/estado para carrinhos `finished` e `abandoned`
...
Plans:
- [x] 14-01: Implementar finalização de carrinho ativo com transição de status e validações
- [x] 14-02: Implementar service de preparação para criação de pedido e integração no fluxo de checkout
