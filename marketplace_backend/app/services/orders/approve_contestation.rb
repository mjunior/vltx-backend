  ...
  class ApproveContestation
    ...
    def call
      ...
      Order.transaction do
        ...
        return Result.new(success?: false, error_code: :not_found) unless locked_order.seller_id == @actor.id
        ...
        transition = Orders::ApplyTransition.call(
          ...
          metadata: { "source" => "seller_approve_contest" }
        )
        unless transition.success?
          failure_code = transition.error_code
